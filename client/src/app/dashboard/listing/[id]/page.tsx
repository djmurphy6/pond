...
export default function ListingPage() {
    ...
    return (
        <div className={`flex flex-col md:flex-row h-screen bg-background transition-colors duration-300`}>
            ...
            <aside style={{ zIndex: 1 }} className={`hidden md:flex w-80 border-l bg-muted/20 p-4 flex flex-col transition-colors duration-300 ${theme !== "dark" && "shadow-[-2px_0_10px_rgba(0,0,0,0.15)]"}`}>
                <Details />
            </aside>
            <div className="flex h-screen overflow-y-auto flex-col md:hidden p-4 bg-muted/20 border-t">
                <Details />
            </div>
            <EditListingModal
                item={editItem}
